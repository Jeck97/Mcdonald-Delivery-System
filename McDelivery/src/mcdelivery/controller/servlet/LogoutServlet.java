...
public class LogoutServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String tracedPathLogout = request.getHeader("referer");
		
		// Set the path into session
		request.setAttribute("tracedPathLogout", tracedPathLogout);
		
		// Forward to logout confirmation page
		request.getRequestDispatcher("confirmLogoutPage.jsp").forward(request, response);
